...
namespace Terme.Infrastructures.Data.SqlServer.Migrations
{
    ...
    [Migration("20191214125243_add_MainPhoto_to_MasterProduct")]
    partial class add_MainPhoto_to_MasterProduct
    {
            ...
            modelBuilder.Entity("Terme.Core.Domain.Masters.Entities.MasterProduct", b =>
                {
                    ...
                    b.HasOne("Terme.Core.Domain.Photos.Entities.Photo", "MainPhoto")
                        .WithMany()
